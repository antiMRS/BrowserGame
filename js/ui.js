...
UI.prototype.update = function() {
	...
	$("#hud-floor-counter").innerHTML = world.dungeon.id + world.dungeon.icon
	$("#hud-health").innerHTML = Math.ceil(this.actor.health)
	$("#hud-hunger").innerHTML = Math.ceil(this.actor.energy) 
	
	$("#debug-hud-X").innerHTML = Math.ceil(this.actor.pos[0])
	$("#debug-hud-Y").innerHTML = Math.ceil(this.actor.pos[1])
	$("#debug-hud-dun-size").innerHTML = world.dungeon.width + ", " + world.dungeon.height
	$("#debug-hud-dun-rooms").innerHTML = world.dungeon.rooms.length
	$("#debug-hud-tile").innerHTML = world.dungeon.getTile(
	this.actor.pos[0],
	this.actor.pos[1]
	).ch
...
UI.prototype.updateStatsScreen = function() {
	...
	$("#stats-hunger").innerHTML = Math.ceil(this.actor.hunger)
}
